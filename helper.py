...
def data_over_time(df, col):
    ...
    year_counts = df_unique['Year'].value_counts()
    nations_over_time = year_counts.reset_index()
...
def most_successful(df, sport):
    ...
    # Count the number of medals for each athlete and get the top 15
    top_athletes = temp_df['Name'].value_counts().reset_index().head(15)
    top_athletes.columns = ['Name', 'Medals']  # Renaming columns for clarity

    # Merge to get additional information about these top athletes
    merged_df = top_athletes.merge(df, left_on='Name', right_on='Name', how='left')[['Name', 'Medals', 'Sport', 'region']].drop_duplicates('Name')
...
def most_successful_countrywise(df, country):
    ...
    # Find the top athletes by medal count
